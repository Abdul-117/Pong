...
float xBallMove = randomXBallMove();
float yBallMove = randomYBallMove();
...
void setup()
{
  ...
  rosesAreFF0000 = createFont("RedRose-Medium.ttf", paddleHeight);
...
void ballMovements()
{
  ...
  xBall += xBallMove * ballSpeed;
  yBall += yBallMove * ballSpeed;
  ballOutBound();
  ballCollision();
...
void resetBall(){
    ...
    xBallMove = randomXBallMove();
    yBallMove = randomYBallMove();
